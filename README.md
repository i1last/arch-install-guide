...
2$ sudo pacman -S xorg xorg-xinit xorg-server bspwm sxhkd neovim alacritty python python-pip rofi rofi-calc rofi-emoji thunar thunar-volman gvfs firefox pulseaudio polybar feh dunst brightnessctl networkmanager numlockx neofetch tldr exa ncdu htop
